...
var budgetController = (function () {
    ...
    return {
        addItem: function (type, des, val) {
            ...
            // [1,2,3,4,5] next id = 6 and that will make a problem if we deleted item
            // [1,2,4,6,8] net id = 9 
            // id = last id + 1
            // create new id 
...
var UIController = (function () {
    ...
    var formatNumber = function (num, type) {
        ...
        if (int.length > 3) {
            // input 2310, output 2,310 and also if the input 23562 it will be output 23,562
...
var controller = (function (budgetCtrl, UICtrl) {
    ...
    var ctrlAddItem = function () {
        var input, newItem;
        // 1- get the field of the input data
        ...
        if (input.description !== "" && !isNaN(input.value) && input.value > 0) {
            ...
            //  6- calcualte and udpate the percentage
            updatePercentages();
        };
    };
    ...
    var ctrlDeleteItem = function (event) {
        ...
        if (itemID) {
            ...
            //  4- calcualte and udpate the percentage
            updatePercentages();
